...
internal static class UiText
{
    ...
    private static readonly IReadOnlyDictionary<string, Text3> Texts =
        new Dictionary<string, Text3>(StringComparer.Ordinal)
        {
            ...
            ["Settings.InstallToolchain"] = new("Встановити інструменти", "Install toolchain", "Toolchain installieren"),
            ["Settings.InstallToolchain.Tooltip"] = new(
                "Завантажує та встановлює Arm GNU Toolchain. Потрібен дозвіл адміністратора; термінал не потрібен.",
                "Downloads and installs the Arm GNU Toolchain. Needs administrator approval; no terminal required.",
                "Lädt die Arm GNU Toolchain herunter und installiert sie. Erfordert eine Administratorfreigabe; kein Terminal nötig."),
            ["Toolchain.Present"] = new("✓ arm-none-eabi-gdb знайдено", "✓ arm-none-eabi-gdb found", "✓ arm-none-eabi-gdb gefunden"),
            ["Toolchain.Missing"] = new(
                "arm-none-eabi-gdb не знайдено — натисніть «Встановити інструменти»",
                "arm-none-eabi-gdb not found — click Install toolchain",
                "arm-none-eabi-gdb nicht gefunden — auf „Toolchain installieren“ klicken"),
            ["Toolchain.Downloading"] = new("Завантаження… {0}", "Downloading… {0}", "Wird heruntergeladen… {0}"),
            ["Toolchain.Installing"] = new(
                "Встановлення — підтвердьте запит Windows",
                "Installing — approve the Windows prompt",
                "Installation — bestätigen Sie die Windows-Abfrage"),
            ["Toolchain.Installed"] = new("✓ Встановлено: {0}", "✓ Installed: {0}", "✓ Installiert: {0}"),
            ["Toolchain.Cancelled"] = new("Встановлення скасовано", "Installation cancelled", "Installation abgebrochen"),
            ["Toolchain.Failed"] = new("Помилка встановлення: {0}", "Installation failed: {0}", "Installation fehlgeschlagen: {0}"),
            ...
            ["Auth.SaveFailed"] = new("Не вдалося зберегти токени у %LOCALAPPDATA%\\Iskra: {0}", "Could not save tokens to %LOCALAPPDATA%\\Iskra: {0}", "Token konnten nicht unter %LOCALAPPDATA%\\Iskra gespeichert werden: {0}"),
