...
internal static class CliText
{
    ...
    private static Dictionary<string, string> Ukrainian() => new(StringComparer.Ordinal)
    {
        ...
        ["Firmware.NoRepoAccess"] = "Немає доступу до репозиторію прошивок {0}. Цей акаунт GitHub не схвалено; попросіть супроводжувача надати доступ.",
        ...
        ["DryRun.RangeOk"] = "Перевірка адрес: пройдено ({0} байт, флеш {1} КБ)",
        ["DryRun.RangeFail"] = "Перевірка адрес: НЕ пройдено — {0}",
        ...
        ["Auth.AdminHint"] = "Перевірте права %LOCALAPPDATA% у Windows, сховище ключів Secret Service у Linux або Keychain у macOS.",
        ...
        ["Doctor.Runtime"] = "Середовище виконання",
        ["Doctor.RuntimeDetail"] = "{0} · {1}",
        ["Doctor.GdbVersionUnknown"] = "не вдалося прочитати версію gdb",
        ["Doctor.AuthClientMissing"] = "Client ID застосунку GitHub не налаштовано у цій збірці",
        ["Doctor.SignedInUntil"] = "вхід виконано, сесія дійсна до {0}",
        ["Doctor.CloudDisabled"] = "вивантаження журналу вимкнено в налаштуваннях",
        ["Doctor.CloudUnconfigured"] = "застосунок GitHub для журналів не налаштовано",
        ["Doctor.CloudNoDatabase"] = "журнал ще не створено",
        ["Doctor.CloudSynced"] = "усі рядки вивантажено",
        ["Doctor.CloudPending"] = "очікують вивантаження: {0}",
        ...
        ["Doctor.LegacyTokenAbsent"] = "застарілий машинний токен відсутній",
        ["Doctor.LegacyTokenRemoved"] = "видалено застарілий машинний токен {0}; відкличте стару авторизацію GitHub і увійдіть знову",
        ["Doctor.LegacyTokenCleanupRequired"] = "видаліть точний файл {0} від імені адміністратора станції: {1}",
        ["Doctor.LegacyTokenBlocksAuth"] = "приватна автентифікація заблокована до видалення застарілого машинного токена",
    ...
    private static Dictionary<string, string> English()
    {
        var d = new Dictionary<string, string>(Ukrainian(), StringComparer.Ordinal)
        {
            ...
            ["Firmware.NoRepoAccess"] = "No access to firmware repository {0}. This GitHub account is not approved; ask the maintainer to grant access.",
            ...
            ["DryRun.RangeOk"] = "Address range check: passed ({0} bytes, {1} KB flash)",
            ["DryRun.RangeFail"] = "Address range check: FAILED - {0}",
            ...
            ["Auth.AdminHint"] = "Check %LOCALAPPDATA% permissions on Windows, the Secret Service keyring on Linux, or Keychain on macOS.",
            ...
            ["Doctor.RuntimeDetail"] = "{0} · {1}",
            ["Doctor.GdbVersionUnknown"] = "could not read the gdb version",
            ["Doctor.AuthClientMissing"] = "the GitHub App client ID is not configured in this build",
            ["Doctor.SignedInUntil"] = "signed in, session valid until {0}",
            ["Doctor.CloudDisabled"] = "log upload is disabled in settings",
            ["Doctor.CloudUnconfigured"] = "the GitHub App for logs is not configured",
            ["Doctor.CloudNoDatabase"] = "the log has not been created yet",
            ["Doctor.CloudSynced"] = "all rows uploaded",
            ["Doctor.CloudPending"] = "rows waiting to upload: {0}",
            ...
            ["Doctor.LegacyTokenAbsent"] = "no legacy machine-wide token is present",
            ["Doctor.LegacyTokenRemoved"] = "removed legacy machine-wide token {0}; revoke the old GitHub authorization and sign in again",
            ["Doctor.LegacyTokenCleanupRequired"] = "remove the exact file {0} as a station administrator: {1}",
            ["Doctor.LegacyTokenBlocksAuth"] = "private authentication is blocked until the legacy machine-wide token is removed",
    ...
    private static Dictionary<string, string> German()
    {
        var d = new Dictionary<string, string>(English(), StringComparer.Ordinal)
        {
            ...
            ["Firmware.NoRepoAccess"] = "Kein Zugriff auf das Firmware-Repository {0}. Dieses GitHub-Konto ist nicht freigegeben; bitten Sie den Betreuer um Zugriff.",
            ...
            ["DryRun.RangeOk"] = "Adressbereichsprüfung: bestanden ({0} Bytes, {1} KB Flash)",
            ["DryRun.RangeFail"] = "Adressbereichsprüfung: FEHLGESCHLAGEN - {0}",
            ...
            ["Auth.AdminHint"] = "Prüfen Sie unter Windows die %LOCALAPPDATA%-Rechte, unter Linux den Secret-Service-Schlüsselbund oder unter macOS Keychain.",
            ...
            ["Doctor.RuntimeDetail"] = "{0} · {1}",
            ["Doctor.GdbVersionUnknown"] = "gdb-Version konnte nicht gelesen werden",
            ["Doctor.AuthClientMissing"] = "Die GitHub-App-Client-ID ist in diesem Build nicht konfiguriert",
            ["Doctor.SignedInUntil"] = "angemeldet, Sitzung gültig bis {0}",
            ["Doctor.CloudDisabled"] = "Protokoll-Upload ist in den Einstellungen deaktiviert",
            ["Doctor.CloudUnconfigured"] = "Die GitHub-App für Protokolle ist nicht konfiguriert",
            ["Doctor.CloudNoDatabase"] = "Das Protokoll wurde noch nicht erstellt",
            ["Doctor.CloudSynced"] = "alle Zeilen hochgeladen",
            ["Doctor.CloudPending"] = "Zeilen, die auf den Upload warten: {0}",
            ...
            ["Doctor.LegacyTokenAbsent"] = "kein veraltetes maschinenweites Token vorhanden",
            ["Doctor.LegacyTokenRemoved"] = "veraltetes maschinenweites Token {0} entfernt; widerrufen Sie die alte GitHub-Autorisierung und melden Sie sich erneut an",
            ["Doctor.LegacyTokenCleanupRequired"] = "entfernen Sie als Stationsadministrator exakt die Datei {0}: {1}",
            ["Doctor.LegacyTokenBlocksAuth"] = "private Authentifizierung bleibt bis zum Entfernen des veralteten maschinenweiten Tokens gesperrt",
