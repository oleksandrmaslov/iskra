...
public static partial class DesktopLocalization
{
    ...
    [
        ...
        (DesktopTextKey.CloseDuringFlash, "Зачекайте завершення прошивання. Закриття Iskra під час запису може залишити пристрій у неповному стані."),
        ...
        (DesktopTextKey.AuthHintRemote, "Ця версія завантажується з GitHub. Увійдіть у розділі авторизації GitHub у Налаштуваннях."),
        ...
        (DesktopTextKey.HistoryMigration, "SQLite залишається локальним джерелом істини. Тут доступні останні спроби, підсумок партії та експорт CSV для партії або всього журналу."),
        ...
        (DesktopTextKey.SettingsMigration, "Налаштування перевіряються та атомарно зберігаються спільним процесом Iskra. Зміни автоматично зберігаються при виході з вкладки."),
        ...
        (DesktopTextKey.SettingsGroupingMigration, "Режим партій, гаряча клавіша, хмарний журнал і шлях до ключа станції керуються тут."),
        ...
        (DesktopTextKey.MacAutoDiscovery, "На macOS Iskra шукає /dev/cu.usbmodem*. Перед виробничим використанням потрібна HIL-перевірка ідентичності USB/серійного номера."),
    ...
    [
        ...
        (DesktopTextKey.CloseDuringFlash, "Wait for flashing to finish. Closing Iskra while data is being written can leave the device in an incomplete state."),
        ...
        (DesktopTextKey.AuthHintRemote, "This release downloads from GitHub. Sign in from the GitHub authentication section in Settings."),
        ...
        (DesktopTextKey.HistoryMigration, "SQLite remains the local source of truth. Recent attempts, a batch summary, and CSV export for the current batch or the complete log are available here."),
        ...
        (DesktopTextKey.SettingsMigration, "Settings are validated and atomically persisted by Iskra's shared workflow. Changes are saved automatically when leaving this tab."),
        ...
        (DesktopTextKey.SettingsGroupingMigration, "Batch mode, the flash hotkey, cloud logging, and the station-key path are managed here."),
        ...
        (DesktopTextKey.MacAutoDiscovery, "On macOS Iskra searches /dev/cu.usbmodem*. USB/serial identity still requires hardware-in-the-loop acceptance before production use."),
    ...
    [
        ...
        (DesktopTextKey.CloseDuringFlash, "Warten Sie, bis das Flashen abgeschlossen ist. Wird Iskra während des Schreibens geschlossen, kann das Gerät unvollständig bleiben."),
        ...
        (DesktopTextKey.AuthHintRemote, "Dieses Release wird von GitHub geladen. Melden Sie sich in den Einstellungen im Abschnitt GitHub-Anmeldung an."),
        ...
        (DesktopTextKey.HistoryMigration, "SQLite bleibt die lokale Quelle der Wahrheit. Letzte Versuche, Chargenübersicht und CSV-Export für die aktuelle Charge oder das vollständige Protokoll sind hier verfügbar."),
        ...
        (DesktopTextKey.SettingsMigration, "Einstellungen werden durch den gemeinsamen Iskra-Ablauf geprüft und atomar gespeichert. Änderungen werden beim Verlassen dieser Registerkarte automatisch gespeichert."),
        (DesktopTextKey.Station, "STATION"),
        ...
        (DesktopTextKey.SettingsGroupingMigration, "Chargenmodus, Flash-Tastenkürzel, Cloud-Protokoll und Stationsschlüsselpfad werden hier verwaltet."),
        ...
        (DesktopTextKey.MacAutoDiscovery, "Unter macOS sucht Iskra nach /dev/cu.usbmodem*. USB-/Serienidentität erfordert vor dem Produktionseinsatz noch eine HIL-Abnahme."),
...
public sealed class DesktopText
{
    ...
    public string CloseDuringFlash => Get(DesktopTextKey.CloseDuringFlash);
